...
def optimize(net_prediction, labels, learning_rate, num_classes):
    ...
    train_step = tf.compat.v1.train.AdamOptimizer(learning_rate=learning_rate).minimize(cross_entropy_loss)
...
if __name__ == '__main__':
    ...
    data_dir = "/content/drive/MyDrive/road/seg/data"
    runs_dir = "/content/drive/MyDrive/road/seg/prediction"
